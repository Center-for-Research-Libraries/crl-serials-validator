...
def get_disqualifying_issue_categories():
    disqualifying_issue_categories = set()
    validator_config = ValidatorConfig()
    for issue in validator_config.config['disqualifying_issues']:
        if validator_config.config['disqualifying_issues'][issue] == '1':
