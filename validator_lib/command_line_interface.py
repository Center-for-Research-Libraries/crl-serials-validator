...
class SimpleValidatorInterface:
        ...
        while True:
            ...
            if response == "visit_docs":
                ...
                error_message, warning_messages = (
                    self.controller.check_if_run_is_possible()
                )
                if error_message:
                    print("")
    ...
    def get_question_map(self):
        ...
        question_map = [""]
        question_map.append(
            ("Visit the Validator documentation in a web browser.", "visit_docs")
        )
        ...
        if self.controller.input_files_seen:
            ...
            question_map.append(
                ("Process input and WorldCat MARC to create outputs.", "process_data")
            )
        return question_map
